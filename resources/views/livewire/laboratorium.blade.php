                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                ...
                                <div class="grid grid-cols-6 gap-6 mt-8">
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <textarea class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="penjelasan_laboratorium_show" disabled>{{ $data->penjelasan_laboratoriums }}</textarea>
                                    </div>
