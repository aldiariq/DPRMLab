            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div class="mb-4 mt-4">
                            <img src="{{ url('assets/img/logodashboard.png') }}" class="h-12 w-12 rounded-full object-cover">
                        </div>
                    </a>
                </div>
                ...
                <!-- :active="request()->routeIs('penelitian')" -->
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-jet-dropdown-link href="{{ route('bimbingan') }}">
                                {{ __('Jadwal Bimbingan') }}
                            </x-jet-dropdown-link>
                            <x-jet-dropdown-link href="{{ route('praktikum') }}">
                                {{ __('Jadwal Praktikum') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>
