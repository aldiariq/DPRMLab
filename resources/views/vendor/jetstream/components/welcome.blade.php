...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com">Kelola Publikasi Penelitian</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Halaman pada menu ini berfungsi untuk mengelola publikasi penelitian mulai dari melihat, menambah, mengubah dan menghapus data publikasi penelitian.
            </div>

            <a href="{{ url('/publikasipenelitian') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                    <div>Menuju Menu</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com">Kelola Demo/Dokumentasi Penelitian</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Halaman pada menu ini berfungsi untuk mengelola demo/dokumentasi penelitian mulai dari melihat, menambah, mengubah dan menghapus data demo/dokumentasi penelitian.
            </div>

            <a href="{{ url('/demodokumentasipenelitian') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                    <div>Menuju Menu</div>
